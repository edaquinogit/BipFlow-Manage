  ...
  >
    ...
    >
      <div class="relative aspect-[4/5] overflow-hidden bg-[#F4F1F3]">
        ...
        >
          <span
            class="rounded-full bg-red-600 px-3 py-1 text-sm font-medium text-white"
          >
            Fora de estoque
          </span>
        </div>
    ...
    <div class="flex flex-1 flex-col p-3.5 min-[390px]:p-4 sm:p-5">
      ...
      <div
        class="mt-3.5 flex items-end justify-between gap-2.5 min-[390px]:mt-4 min-[390px]:gap-3"
      >
        <div>
          <span
        ...
        <button
          ...
          @click="handleOpenDetails"
        >
          <span class="truncate">Detalhe</span>
          <ArrowRightIcon
            class="h-3.5 w-3.5 shrink-0 min-[390px]:h-4 min-[390px]:w-4"
            aria-hidden="true"
          />
        </button>
      </div>
      ...
      <div class="mt-auto pt-3.5 min-[390px]:pt-4">
        <div
          class="grid grid-cols-[auto,minmax(0,1fr)] items-center gap-1.5 min-[390px]:gap-2"
        >
          <div class="min-w-0">
            <div
          ...
          >
            <ShoppingBagIcon
              class="h-3.5 w-3.5 shrink-0 min-[390px]:h-4 min-[390px]:w-4 min-[480px]:h-4.5 min-[480px]:w-4.5"
              aria-hidden="true"
            />
            <span class="hidden truncate whitespace-nowrap sm:inline">{{
              addToCartLabel
            }}</span>
            <span
              class="hidden truncate whitespace-nowrap min-[390px]:inline sm:hidden"
              >{{ mediumAddToCartLabel }}</span
            >
            <span class="truncate whitespace-nowrap min-[390px]:hidden">{{
              compactAddToCartLabel
            }}</span>
          </button>
        </div>
      </div>
