...
<template>
  <div
    ...
    class="group relative overflow-hidden bg-zinc-900/40 border border-white/5 p-8 rounded-[2.5rem] backdrop-blur-md transition-all duration-500 hover:border-white/10 hover:bg-zinc-900/60"
  >
