  ...
  <section class="space-y-6 pb-4">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
      <div
        ...
        :key="slot.key"
        class="group relative flex h-44 items-center justify-center overflow-hidden rounded-xl border border-dashed border-[#D1D5DB] bg-zinc-50 transition-all hover:border-[#111827]/50"
        :class="{ 'border-[#111827]/40 bg-[#F3F4F6]': error }"
      >
        ...
        <div class="pointer-events-none z-10 flex flex-col items-center gap-3 px-3 text-center">
          <div
            class="flex h-10 w-10 items-center justify-center rounded-full bg-white text-bip-muted transition-all duration-300 group-hover:bg-[#F3F4F6] group-hover:text-[#111827]"
            :class="{ 'bg-[#F3F4F6] text-[#111827]': slot.preview }"
          >
