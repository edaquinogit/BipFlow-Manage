...
interface Props {
  ...
  // stock-exit evolution) and never editable from this form.
...
const selectedCategoryName = computed(() => {
  ...
  return selectedCategory ? getCategoryDisplayName(selectedCategory) : 'Selecionar categoria';
});
    ...
    <div class="group flex flex-col">
      ...
      <div class="relative" @click.stop @focusout="handleCategoryFocusOut">
        ...
        <Transition name="category-popover">
          ...
          >
            <template v-for="item in categoryTree" :key="item.id">
              <button
                type="button"
                role="option"
