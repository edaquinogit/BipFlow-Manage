...
class GlobalExceptionMiddlewareTests(TestCase):
    ...
    def test_validation_error_handling(self):
        ...
        response = self.middleware._handle_known_exception(validation_error, self.mock_request, 'test-request-id')
    ...
    def test_http404_handling(self):
        ...
        response = self.middleware._handle_known_exception(Http404(), self.mock_request, 'test-request-id')
    ...
    def test_permission_denied_handling(self):
        ...
        response = self.middleware._handle_known_exception(PermissionDenied(), self.mock_request, 'test-request-id')
    ...
    def test_api_exception_handling(self):
        ...
        response = self.middleware._handle_known_exception(api_exception, self.mock_request, 'test-request-id')
    ...
    def test_server_error_handling(self):
        ...
        response = self.middleware._handle_server_error(Exception('Test error'), self.mock_request, 'test-request-id')
