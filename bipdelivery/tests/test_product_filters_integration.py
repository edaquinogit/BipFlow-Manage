...
class ProductFilterIntegrationTest(TestCase):
    ...
    def test_filter_by_min_price(self) -> None:
        ...
        response: Any = self.client.get("/api/v1/products/", {"min_price": "50.00"})
    ...
    def test_filter_by_max_price(self) -> None:
        ...
        response: Any = self.client.get("/api/v1/products/", {"max_price": "60.00"})
    ...
    def test_filter_by_price_range(self) -> None:
        ...
        response: Any = self.client.get(
            "/api/v1/products/", {"min_price": "40.00", "max_price": "90.00"}
        )
    ...
    def test_filter_by_in_stock(self) -> None:
        ...
        response: Any = self.client.get("/api/v1/products/", {"in_stock": "true"})
    ...
    def test_combined_filters_price_and_stock(self) -> None:
        ...
        response: Any = self.client.get(
            "/api/v1/products/", {"min_price": "30.00", "max_price": "80.00", "in_stock": "true"}
        )
    ...
    def test_filter_with_invalid_price_value(self) -> None:
        ...
        response: Any = self.client.get("/api/v1/products/", {"min_price": "not-a-number"})
    ...
    def test_filter_backwards_compatibility_old_params(self) -> None:
        ...
        """
        response: Any = self.client.get(
            "/api/v1/products/", {"price__gte": "50.00"}  # Old frontend syntax
        )
    ...
    def test_filter_integration_example_ui_scenario(self) -> None:
        ...
        response: Any = self.client.get(
            "/api/v1/products/", {"min_price": "40.00", "max_price": "80.00", "in_stock": "true"}
        )
