...
coluna, sem tabelas, icones ou caixas de texto.

## O Que Foi Mantido

- Projeto BipFlow como principal evidencia tecnica.
- Stack com Python, Django REST Framework, Vue 3, TypeScript, Node.js e SQL.
- Testes, lint, typecheck, documentacao e Git como diferenciais.
- Experiencia operacional/tecnica na Imperio CMB, desde que descrita com
  foco em analise, SQL, integracao e melhoria de processo.

## O Que Foi Ajustado

- Trocar posicionamento de "Software Engineer" por "Desenvolvedor Full Stack
  Junior", mais coerente com o objetivo atual.
